...
<a href="https://openclaw.ai/"><img align="right" src="tmpl/assets/logo.png" alt="awesome-openclaw-skills" title="awesome-openclaw-skills" /></a>
...
- [ai-coder](skills/ai-coder.md) - AI 编程助手
- [ai-agent-helper](skills/ai-agent-helper.md) - AI Agent 设定优化助手
- [code-quality](skills/code-quality.md) - 代码质量审查
...
- [github-cli](skills/github-cli.md) - GitHub CLI
- [skill-finder-cn](skills/skill-finder-cn.md) - 找 Skill
- [hawk-bridge](skills/hawk-bridge.md) - 记忆系统桥接

## System Management

- [wbs-planner](skills/wbs-planner.md) - WBS 计划工具
- [openclaw](skills/openclaw.md) - OpenClaw 核心

## Platforms

- [ai-agent-helper](#) - Agent 设计助手
